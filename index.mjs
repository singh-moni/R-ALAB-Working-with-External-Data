...
breedSelect.addEventListener('change', async () => {
  try {
      ...
      const breedInfo = await response.json(); // Convert the response to JSON format

      // Iterate over the response array and create carousel elements
      ...
      infoDump.innerHTML = `
          ...
          <p>Description: ${breedInfo[0].breeds[0].description}</p>
